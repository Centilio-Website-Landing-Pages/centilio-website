        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/integrations" className="text-white text-sm hover:text-gray-300 transition-colors">
                Integrations
              </Link>
              <Link href="/pricing-sign" className="text-white text-sm hover:text-gray-300 transition-colors">
                Pricing
              </Link>
